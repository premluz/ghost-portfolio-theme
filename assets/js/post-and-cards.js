        ...
        try {
          ...
          if (meta.cardDescription) {
            ...
            statementSlide.innerHTML = `
              <div class="statement-container" data-card-reveal="slide-left">
            ...
            // direction tracking, just registered later. 'slide-left' is
            // the existing variant already invokable standalone via
            // data-card-reveal (slide in from the right + fade), the same
            // motion used elsewhere — no new config needed.
